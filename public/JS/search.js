...
/**
 * Sets up product data and local storage.
 * Starts with an empty product list and default selection.
 * Sets cache keys and a 24-hour time limit.
 * Connects to the 'products' collection in Firestore.
 */
let products = [];
